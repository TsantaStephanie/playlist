...
.filters input { padding: 0.45rem 0.75rem; border: 1px solid #f0f0f0; border-radius: 6px; background: #e8e8e8; color: #eee; font-size: 0.9rem; }
...
.filters button[type="button"] { background: #393e47; color: #eee; }
.info { color: #aaa; }
.error { color: #f87171; }
.count { color: #aaa; font-size: 0.85rem; margin-bottom: 0.5rem; }
.table-wrap { overflow-x: auto; }
table { width: 100%; border-collapse: collapse; font-size: 0.88rem; }
th { text-align: left; padding: 0.55rem 0.75rem; background: #0c0c14; color: #d9dfe8; font-weight: 600; border-bottom: 1px solid #333; }
td { padding: 0.5rem 0.75rem; border-bottom: 1px solid #2a2a3e; color: #242020; }
